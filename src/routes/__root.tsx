...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Estúdio independente criando sites imersivos e de alto padrão para marcas ambiciosas." },
      { name: "author", content: "studio." },
      { property: "og:title", content: "Teste1. — Sites que ganham vida" },
      { property: "og:description", content: "Estúdio independente criando sites imersivos e de alto padrão para marcas ambiciosas." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Teste1. — Sites que ganham vida" },
      { name: "twitter:description", content: "Estúdio independente criando sites imersivos e de alto padrão para marcas ambiciosas." },
